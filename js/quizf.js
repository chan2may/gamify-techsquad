...
function loadNextQuestion() {
    ...
    <div class="outfit">
        <a href="https://www.myntra.com/11118550"><img id="outfit" src="images/rachelfoutfit.jpg" alt="outfit"></a>
    </div>
    </div>

    <a href="https://www.myntra.com/11118550"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
    ...
    <h1 id="head">HERE'S AN OUTFIT <br> FOR YOU !</h1>
    <div class="outfit">
        <a href="https://www.myntra.com/15198494"><img id="outfit" src="images/rossfoutfit.jpg" alt="outfit"></a>
    </div>
    </div>
    <a href="https://www.myntra.com/15198494"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
    <img class="icon" src="images/shop now icon.png" alt="icon">`;
            return;
       ...
       <h1 id="head">HERE'S AN OUTFIT <br> FOR YOU !</h1>
       <div class="outfit">
           <a href="https://www.myntra.com/blazers/mango/mango-women-off-white-solid-linen-double-breasted-blazer/12524540/buy"><img id="outfit" src="images/chandlerfoutfit.jpg" alt="outfit"></a>
       </div>
       </div>
       <a href="https://www.myntra.com/blazers/mango/mango-women-off-white-solid-linen-double-breasted-blazer/12524540/buy"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
       <img class="icon" src="images/shop now icon.png" alt="icon">`;
            return;
        ...
        <div class="character-container">   
           ...
           <h1 id="head">HERE'S AN OUTFIT <br> FOR YOU !</h1>
           <div class="outfit">
               <a href="https://www.myntra.com/dresses/veni-vidi-vici/veni-vidi-vici-red-solid-ruched-bodycon-dress/10054835/buy"><img id="outfit" src="images/monicafoutfit.jpg" alt="outfit"></a>
           </div>
           </div>
           <a href="https://www.myntra.com/dresses/veni-vidi-vici/veni-vidi-vici-red-solid-ruched-bodycon-dress/10054835/buy"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
           <img class="icon" src="images/shop now icon.png" alt="icon">`;
            return;
       ...
       <h1 id="head">HERE'S AN OUTFIT <br> FOR YOU !</h1>
       <div class="outfit">
           <a href="https://www.myntra.com/15198418"><img id="outfit" src="images/joeyfoutfit.jpg" alt="outfit"></a>
       </div>
       </div>
       <a href="https://www.myntra.com/15198418"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
       <img class="icon" src="images/shop now icon.png" alt="icon">`;
            return;
        } else {
            result.innerHTML = `<!--Display character-->
       ...
       <h1 id="head">HERE'S AN OUTFIT <br> FOR YOU !</h1>
       <div class="outfit">
           <a href="https://www.myntra.com/dress/stylestone/stylestone-women-denim-blue-solid-pinafore-dress/10702346/buy"><img id="outfit" src="images/phoebefoutfit.jpg" alt="outfit"></a>
       </div>
       </div>
       <a href="https://www.myntra.com/dress/stylestone/stylestone-women-denim-blue-solid-pinafore-dress/10702346/buy"><button style="text-align: center; padding-right: 20px;" id="button"><b>Shop Now</b></button></a>
       <img class="icon" src="images/shop now icon.png" alt="icon">`;
            return;
        }
